...
export const Footer = () => {
    return (
        <footer className="footer">
            <section className="footer__box footer__box--gap-lg">
                <section className="footer__box footer__box--gap-sm">
                    <section className="footer__box footer__box--gap-md footer__box--max">
                        <Logo />
